...
export default class ErrorBoundary extends React.Component<Props, State> {
  ...
  componentDidCatch(error: Error) {
    if (typeof console !== 'undefined') console.error('RWAkins ErrorBoundary:', error)
  }
  ...
  render() {
    ...
    return (
      <div className="card" style={{ borderColor: '#3B5BFA' }}>
        <h3 className="gold-text">Something went wrong with this module.</h3>
        <p>The rest of RWAkins is still running.</p>
