  ...
  const slides: NarrativeSlide[] = [
    {
      ...
      paragraphs: [
        ...
        'RWAkins resolves this by treating blockchain environments as integrated operational channels of a single unified OS. We absorb active wallet contexts reactively, allowing distinct tools to share synchronized parameters in client memory.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'RWAkins blends these paradigms into a high-security coordination layer. Advanced LLM pipelines analyze complex liquidity states and negotiate rates, but every transaction must pass detached Freighter XDR or Phantom Ed25519 signature checks before execution.',
    ...
    },
    {
      ...
      paragraphs: [
        'Web3 regional nodes are prone to frequent packet dropouts and memory congestion. RWAkins builds systemic resilience directly into our core telemetry layer.',
    ...
    },
    {
      ...
      paragraphs: [
        'Staking and lending yields fluctuate continuously across EVM L2 and Mantle environments. Retrospective periodic sweeps lock up critical capital.',
        'RWAkins coordinates an autonomous cross-chain event bus that listens to gas limits and yields. When a staking APY spikes on Mantle, the engine dispatches optimized rebalance proposals to corporate stakeholders.',
      ...
      metrics: [
        { label: 'Supported Chains', value: 'Mantle Network, Mantle Sepolia' },
    ...
    },
    {
      ...
      paragraphs: [
        'Modern Yield Operations Hub assets demand continuous operational execution. RWAkins envisions a future where multi-party payroll streams, debt optimization pools, and AI nodes operate autonomously.',
        'To stress-test these scenarios safely, RWAkins integrates an isolated Digital Twin framework. Executives can simulate heavy congestions, key compromise compromises, and RPC cascades to verify automated AI safeties in sandboxed sandboxes.',
        'By combining physical execution with synthetic twin simulations, RWAkins empowers enterprises and DAOs with unprecedented control over digital assets and liquid flows.'
      ],
      metrics: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'RWAkins introduces Operational Sovereignty by establishing a decentralized, self-governing consensus mesh. Nodes continuously verify quorum signatures, validate execution parameters, and maintain an independent operational state.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'RWAkins balances these flows through our Autonomous Economic Coordination engine. The engine models dynamic pool flows and calculates coordinate rewards to incentivize healthy liquidity distributions.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'RWAkins heralds a new operational standard by establishing an independent, self-governing consensus mesh. Nodes continuously verify transaction quorums, calibrate latency targets, and maintain localized state databases.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'RWAkins balances resources proactively through the Autonomous Economic Coordination engine. The engine models liquidity pools dynamically and adjust reward levels to correct multi-chain yield imbalances.',
    ...
    },
    {
      ...
      paragraphs: [
        'As organizations scale across Mantle Network and Mantle Sepolia, infrastructure data becomes highly fragmented.',
        'RWAkins solves this by implementing our stateful Global Operations Engine, which synchronizes telemetry updates, governance votes, and transaction sweeps into a single, authoritative ledger.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'RWAkins embeds agents within our deterministic Infrastructure Policy Engine, which automatically enforces limits, checks consensus drift, and logs decision rationale in zero-knowledge decision chains.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'RWAkins represents the pinnacle of this shift, providing enterprises, DAOs, and developers with a complete, single-product operating system.',
        'With state-of-the-art aesthetics and absolute mathematical reliability, RWAkins is fully prepared to orchestrate the next chapter of digital finance.'
      ],
      metrics: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'RWAkins resolves this by coordinating the Global Event Bus statefully, triggering deterministic, multi-step mitigation sequences across secondary validator zones.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'RWAkins bridges this gap by coordinating incentive sweeps in direct response to the global consensus health and regional volatility.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'RWAkins moves past these constraints by orchestrating a civilization-scale network where autonomous institutional entities coordinate, negotiate, and align statefully.',
    ...
    },
    {
      ...
      paragraphs: [
        'Monolithic operational controls are single points of failure. In RWAkins, coordination is delegated to six autonomous institutional agents.',
    ...
    },
    {
      ...
      paragraphs: [
        'When network friction occurs, standard protocols fail back to rigid outages or human manual overrides. RWAkins introduces Protocol Diplomacy.',
    ...
    },
    {
      ...
      paragraphs: [
        'Machine-speed optimization without policy gating creates vulnerability. In RWAkins, all agent decisions must align with strict, zero-knowledge constraints.',
    ...
    },
    {
      ...
      paragraphs: [
        'With permanently synchronized global engines, predictive forecasting layers, and a multi-agent civilization mesh, RWAkins completes its vision.',
        ...
        'Fully optimized, certified accelerator-ready, and strategically fortified, RWAkins is prepared to govern the decentralized future.'
      ],
      metrics: [
  ...
  return (
    <main className="dashboard-layout" style={{ maxWidth: 1000, margin: '0 auto', padding: '20px 24px' }}>
      ...
      <section 
        ...
        style={{ 
          padding: '40px 48px', 
          background: 'linear-gradient(180deg, rgba(59,91,250,0.02) 0%, rgba(0,0,0,0) 100%)',
          borderWidth: 1,
          borderStyle: 'solid',
          borderColor: 'rgba(59,91,250,0.25)',
          borderRadius: 12,
          minHeight: 380,
          display: 'flex',
      ...
      >
        <div>
          <p className="eyebrow" style={{ color: '#3B5BFA', fontSize: 11, fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.1em', margin: '0 0 8px' }}>
            Slide {activeSlideIndex + 1} of {slides.length}
          </p>
          <h2 style={{ fontSize: 32, margin: '0 0 4px', fontWeight: 800, color: '#0A0F2E', letterSpacing: '-0.02em' }}>
            {slide.title}
          </h2>
          <h3 style={{ fontSize: 16, margin: '0 0 24px', fontWeight: 500, color: '#3B5BFA' }}>
            {slide.subtitle}
          </h3>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderTop: '1px solid #F8FAFC', paddingTop: 20, flexWrap: 'wrap', gap: 16 }}>
          <div style={{ display: 'flex', gap: 32 }}>
            {slide.metrics.map((m, idx) => (
              <div key={idx}>
                <span style={{ fontSize: 10, color: '#888', textTransform: 'uppercase', letterSpacing: '0.05em' }}>{m.label}</span>
                <h4 style={{ margin: '2px 0 0', fontSize: 18, color: '#0A0F2E', fontWeight: 700 }}>{m.value}</h4>
              </div>
            ))}
          </div>
        ...
        {slides.map((s, idx) => (
          <button
            ...
            style={{
              ...
              height: 10,
              borderRadius: '50%',
              background: activeSlideIndex === idx ? '#3B5BFA' : '#CBD5E1',
              border: 'none',
              cursor: 'pointer',
              padding: 0,
