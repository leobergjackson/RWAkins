...
export const SHADOW_API = process.env.NEXT_PUBLIC_SHADOW_API || ''
export const PALMFLOW_API = process.env.NEXT_PUBLIC_PALMFLOW_API || ''
export const CIPHER_API = process.env.NEXT_PUBLIC_CIPHER_API || ''
